 ...
 */
abstract contract CentralizedArbitratorERC20 is Arbitrator {
     ...
     */
    function arbitrationCost() public view returns (uint256 fee) {
     ...
     *  @return fee Amount to be paid.
     */
    function appealCost() public pure returns (uint256 fee) {
     ...
     *  @param _token Token to be used for the arbitration.
    ...
    function _giveRuling(uint256 _disputeID, uint256 _ruling) internal {
        ...
        IERC20(dispute.token).transfer(address(this), dispute.fee);
