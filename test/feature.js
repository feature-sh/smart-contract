...
let deployer, sender0, receiver0, sender1, receiver1, sender2, receiver2, sender3, receiver3, sender4, receiver4, challenger0, sender5, receiver5, challenger1, sender6, receiver6, challenger2;
...
beforeEach(async function () {
  ...
  [deployer, sender0, receiver0, sender1, receiver1, sender2, receiver2, sender3, receiver3, sender4, receiver4, challenger0, sender5, receiver5, challenger1, sender6, receiver6, challenger2] = await ethers.getSigners();
...
describe("Feature", function () {
  ...
  it("Should give the amount of the total deposit to the claimer after a successful appeal", async function () {
    ...
    const gasFeeAppealTx = transactionMinedAppealTx.gasUsed.valueOf().mul(150000000000);
    ...
    const newBalanceReceiver6Expected = new ethers.BigNumber.from("10000000000000000000000").sub(gasFeeClaimTx).sub(gasFeeAppealTx).sub("40000000000000000");

    expect((await provider.getBalance(receiver6.address)).toString()).to.equal(newBalanceReceiver6Expected.toString());
  });
});
